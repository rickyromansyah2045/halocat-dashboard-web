  	...
  	<body>
		<header class="header_box dl_header">
			...
			<div class="jumbotron jhabout" style="padding-top: 150px;">
				<p class="all_judul_header">List Artikel</p>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<select class="form-control dl_input_txt_header" id="filter-sort_by">
								<option value=""></option>
								<option value="oldest">Oldest Contents</option>
								<option value="newest">Newest Contents</option>
		...
		<script>
			...
			function newRequest(search = "", category = "", limit = "9", offset = "0", orderBy = "id", orderType = "DESC") {
				...
				$.ajax({
					url: `<?= $_ENV['API_URL']; ?>/contents${query}`,
					type: 'GET',
