<head>
	...
	<meta name="description" content="Healthy Cat, Happy Owner - Halocat">
    <meta name="author" content="Ricky Romansyah">
	<title><?= $title; ?> - Halocat App</title>
	...
	<link rel="stylesheet" href="<?= base_url('assets/css/custom-style-front.css')?>">
	<link rel="shortcut icon" href="<?= base_url('assets/favicon.ico'); ?>" type="image/x-icon">
	<link rel="stylesheet" href="<?= base_url('assets/css/styles_mobile.css')?>">
