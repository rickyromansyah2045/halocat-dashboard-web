			...
			<ul class="navbar-nav mr0">
				<?php if ($this->session->has_userdata('id')): ?>
					<?php if ($this->session->userdata('role') == "user"): ?>
						<a class="nav-link nav_link_menu" href="<?= site_url('user/dashboard'); ?>" style="margin-right: 0; padding-right: 0;">User Area</a>
					<?php else: ?>
						<a class="nav-link nav_link_menu" href="<?= site_url('admin/dashboard'); ?>" style="margin-right: 0; padding-right: 0;">Admin Area</a>
					<?php endif; ?>
				<?php else: ?>
					<a class="nav-link nav_link_menu" href="<?= site_url('auth/register'); ?>">Register</a>
					<a class="nav-link nav_link_menu" href="<?= site_url('auth/login'); ?>" style="margin-right: 0; padding-right: 0;">Login</a>
				<?php endif; ?>
			</ul>
		</div>
	</div>
